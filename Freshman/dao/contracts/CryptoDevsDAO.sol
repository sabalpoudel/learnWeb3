...
contract CryptoDevsDAO is Ownable {
    ...
    struct Proposal {
        // tokenID of the NFT to purchase from FakeNFTMarketplace if the proposal passes
        uint256 nftTokenId;
        //UNIX timestamp until which this proposal is active. Proposal can be executed after the deadline has been exceeded.
        uint256 deadline;
        // number of yay votes for this proposal
        uint256 yayVotes;
        // number of nay votes for this proposal
        uint256 nayVotes;
        // ewhether or not this proposal has been executed yet. Cannot be executed before the deadline has been exceeded.
        bool executed;
